...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser('Bricks Markup Language')
...
def main(args=None):
    """
    Called with ``python -m bml.tests``: run main test suite.
    """
    ...
    import bml.tests as test_module
